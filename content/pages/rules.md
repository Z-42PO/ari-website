...
{{< gslides src="https://docs.google.com/presentation/d/1T1josMd5P9RZgY1TbQPzH5U5o101DXlwoRYocLttRBM/embed" title="Presentation, Brief imprimé" >}}
...
Bien que l'ARI ne pratique pas le Milsim (simulation militaire, démarche se voulant au plus près de la réalité), il nous tient à coeur de proposer un jeu riche, immersif et équilibré. Les technologies et possibilités offertes par l'airsoft étant virtuellement illimitées, ce cadre est indispensable afin d'éviter toute dérive d'ordre compétitive, recherche de performance sans compromis voire "pay-to-win".
...
- Contrairement à beaucoup d'association, les rafales sont autorisées. En effet, la technologie permet aujourd'hui de tirer "en semi" parfois plus vite qu'en rafales. Nous retirons donc l'incitation à acheter du matériel plus pointu qui désavantagerai les joueurs plus modestes. En contrepartie, nous limitons l'emport de munitions. L'usage du tir en rafales ajoute 10 mètres à la distance habituellement pratiquée par la classe de la réplique. Ex : un fusil d'assaut (classe 2) peut soit tirer en semi à 10m minimum, soit en rafales à 20m minimum ;
